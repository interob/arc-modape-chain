...
class ModisInterleavedOctad(TimeSlice):
    ...
    def getDateTimeStart(self):
        return datetime.datetime.strptime(
            "{}{}".format(self.__year, ((self.__seqno - 1) * 8) + 1), "%Y%j"
        )
    ...
    def startsBeforeDate(self, someDate):
        return self.getDateTimeStart() < datetime.datetime(
            someDate.year, someDate.month, someDate.day
        )

    def endsAfterDate(self, someDate):
        return self.getDateTimeEnd() > datetime.datetime(
            someDate.year, someDate.month, someDate.day, 23, 59
        )
